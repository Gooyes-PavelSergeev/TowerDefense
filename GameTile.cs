...
public class GameTile : MonoBehaviour
{
    ...
    private GameTile _north, _south, _east, _west;
    ...
    public static void SwapEastWest(GameTile east, GameTile west)
    {
        west._east = east;
        east._west = west;
    }

    public static void SwapNorthSouth(GameTile north, GameTile south)
    {
        north._south = south;
        south._north = north;
    }
